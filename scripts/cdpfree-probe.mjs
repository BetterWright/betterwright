...
//
// Usage:
//   node scripts/cdpfree-probe.mjs [--browser /path/to/binary] [--headed]
//   node scripts/cdpfree-probe.mjs --url https://example.com --selector h1
...
function rpc(op, payload = {}, timeoutMs = 60_000) {
