// Resolved for CPython 3.12.13, Linux x86_64 glibc 2.35+ on 2026-09-13.
// Regenerate from a requirements.in containing vllm==0.29.0, then review:
// uv pip compile requirements.in --python-version 3.12.13 --python-platform
// x86_64-manylinux_2_35 --only-binary :all: --no-annotate --no-header --strip-extras
export const LOCAL_VLLM_REQUIREMENTS = [
