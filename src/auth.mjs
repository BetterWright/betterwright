...
// (the ChatGPT-backend Responses API, or xAI) is the adapter's job in agent.mjs.
...
function startCallbackServer(provider, { state, log }) {
 ...
 */
export async function loginProvider(options = {}) {
